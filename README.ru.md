...
Сопровождающий проект на github [SVETlANNa.docs](https://github.com/CompPhysLab/SVETlANNa.docs/blob/main/README.ru.md) содержит различные примеры использования библиотеки в формате блокнотов Jupyter.
